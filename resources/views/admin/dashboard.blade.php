                                ...
                                <div class="box p-0">
                                    <div class="box-body">
                                        <div class="d-flex align-items-center">
                                            <div class="review-tx">
                                                <div class="d-flex mb-10">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0"><small class="text-mute">1 day
                                                                ago</small></p>
                                                    </div>
                                                </div>
                                            ...
                                            <img src="../images/food/dish-1.png" class="dish-img"
                                                alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="box p-0">
                                    <div class="box-body">
                                        <div class="d-flex align-items-center">
                                            <div class="review-tx">
                                                <div class="d-flex mb-10">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0"><small class="text-mute">2 day
                                                                ago</small></p>
                                                    </div>
                                                </div>
                                                <p class="mb-10">Lorem ipsum dolor sit amet, consectetur
                                            ...
                                            <img src="../images/food/dish-2.png" class="dish-img"
                                                alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="box p-0">
                                    <div class="box-body">
                                        <div class="d-flex align-items-center">
                                            <div class="review-tx">
                                                <div class="d-flex mb-10">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0"><small class="text-mute">3 day
                                                                ago</small></p>
                                                    </div>
                                                </div>
                                                <p class="mb-10">Lorem ipsum dolor sit amet, consectetur
                                            ...
                                            <img src="../images/food/dish-3.png" class="dish-img"
                                                alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="box p-0">
                                    <div class="box-body">
                                        <div class="d-flex align-items-center">
                                            <div class="review-tx">
                                                <div class="d-flex mb-10">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="mb-0"><small class="text-mute">4 day
                                                                ago</small></p>
                                                    </div>
                                                </div>
                                                <p class="mb-10">Lorem ipsum dolor sit amet, consectetur
                                            ...
                                            <img src="../images/food/dish-4.png" class="dish-img"
                                                alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="box p-0">
                                    <div class="box-body">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <img src="../images/food/dish-5.png" class="dish-img"
                                                alt="" />
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xxxl-5 col-12">
                    <div class="box">
                        <div class="box-header no-border">
                            <h4 class="box-title">
                                Trending Keyword
                                <small class="subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing
                                    elit</small>
                            </h4>
                        </div>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body pt-0">
                            <div class="mb-5">
                                <img class="rounded img-fluid" src="../images/food/img1.jpg"
                                    alt="">
                            </div>
                            <div class="info-content">
                                <h5 class="my-15"><a href="ecommerce_details.html">Spicy Pizza with Extra
                                        Cheese</a></h5>
                        ...
                        <div class="box-body">
                            ...
                            <div class="pt-30">
                                ...
                                <div class="bb-1 pb-10 mb-20 d-lg-flex d-block justify-content-between">
                                    <div class="d-flex">
                                        <img src="../images/avatar/4.jpg" class="w-40 h-40 me-10 rounded100"
                                            alt="">
                                        <div>
                                            <p class="mb-0">Stepni Doe <span class="text-primary ms-10">(3
                                                    items)</span></p>
                                            <p class="mb-0"><small class="text-mute">will be shipping on
                                                    10:12 am</small></p>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                ...
                                <div class="bb-1 pb-10 mb-20  d-lg-flex d-block justify-content-between">
                                    <div class="d-flex">
                                        <img src="../images/avatar/5.jpg" class="w-40 h-40 me-10 rounded100"
                                            alt="">
                                        <div>
                                            <p class="mb-0">Mical clark <span
                                                    class="text-primary ms-10">(2 items)</span></p>
                                            <p class="mb-0"><small class="text-mute">will be shipping on
                                                    12:12 am</small></p>
                                        </div>
                                    </div>
                                ...
                                <div class="bb-1 pb-10  d-lg-flex d-block justify-content-between">
                                    <div class="d-flex">
                                        <img src="../images/avatar/7.jpg" class="w-40 h-40 me-10 rounded100"
                                            alt="">
                                        <div>
                                            <p class="mb-0">Steponi mohan <span
                                                    class="text-primary ms-10">(7 items)</span></p>
                                            <p class="mb-0"><small class="text-mute">will be shipping on
                                                    11:12 am</small></p>
                                        </div>
                                    </div>
