                            ...
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        ...
                                        <i class="mdi mdi-home-outline"></i> Quotes </a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Submited Quotes</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        @foreach ($acceptedQuotes as $quote)
                            <div class="col-lg-3 col-md-6">
                                <div class="box bg-default box-inverse no-radius">
                                    <div class="box-body">
                                        <h5 class="mt-0 mb-3">
                                            <img src="{{ $quote->workshop->user->getFirstMediaUrl('profile_photo', 'thumb') }}"
                                                class="user-image rounded-circle avatar bg-white mx-10" alt="">
                                            {{ $quote->workshop->user->name }}
                                        </h5>
                                        <hr>
                                        ...
                                        <span class="font-500 pull-right btn  text-white btn-sm no-radius accept_quote"> {{ ucfirst($quote->status) }} </span>
                                        <span class="pull-left">Date: {{ $quote->quote->quote_date }} </span>
