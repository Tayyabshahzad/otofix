					...
					<div class="col-lg-5 col-md-5 col-12">
						<div class="bg-white rounded10 shadow-lg">
							<div class="content-top-agile p-20 pb-0">
								...
								<p class="mb-0">Login to continue to AutoFixx.</p>
                                @if ($errors->any())
                                <div >
                                    <br>
							...
							<div class="p-40">
								<form method="POST" action="{{ route('phone.login.process') }}">
                                    @csrf
									<div class="form-group row">
                                        <div class="col-lg-5">
                                            <div class="input-group">
                                                <span class="input-group-text bg-transparent"><i class="ti-mobile"></i></span>
                                                <select class="form-control ps-15 bg-transparent" name="cc" required>
									  ...
									  <div class="row">
                                        <a href="{{ route('login')}}" class="hover-warning"><i class="ti-email"></i> Login using email?</a><br>
										<!-- /.col -->
